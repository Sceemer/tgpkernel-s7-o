# -------------------------------
# TGPKERNEL AROMA INSTALLER 4.7.3
# anykernel2 portion
#
...
chmod 755 $ramdisk/sbin/init.dalvik.sh
chmod 755 $ramdisk/sbin/kernelinit.sh
chmod 755 $ramdisk/sbin/resetprop
chmod 755 $ramdisk/sbin/sysinit.sh
chmod 755 $ramdisk/init.services.rc
insert_line init.rc "import /init.services.rc" after "import /init.wifi.rc" "import /init.services.rc"
